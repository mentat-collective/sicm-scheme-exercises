;; Exercise 1.8*, ps1, p28 - implementation of delta

;; This FEELS weird... but we want something that is
;;
;;
...
;; This is a path function that returns a 2d path; we can use this as an
;; example.
