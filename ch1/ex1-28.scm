...
;; It's easier to confirm that this is not a total time derivative by checking
;; the partials.
...
;; ## Part D
;;
;; This is NOT a total time derivative; you can tell by taking the partials of
;; each side, G0 and G1, as we'll see here.
...
;; ## Part E
;;
;; This is strange to me, because I thought that this thing had to produce a
;; tuple.
;;
;; OH, but the secret is that Qdot is also a tuple, so you contract them
;; together.
;;
...
;; AND it looks like we DO have a total time derivative, maybe. We certainly
;; pass the first test here, since the second and third tuple entries are equal.
;;
