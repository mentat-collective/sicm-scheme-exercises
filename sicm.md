...
- [Lagrangian Mechanics](#sec-1)
  ...
  - [Exercise 1.4: Lagrangian actions](#sec-1-3)
  - [Exercise 1.5: Solution process](#sec-1-4)
  - [Exercise 1.6: Minimizing action](#sec-1-5)
  - [Exercise 1.7: Properties of \\(\delta\\)](#sec-1-6)
  - [Exercise 1.8: Implementation of \\(\delta\\)](#sec-1-7)
  - [Exercise 1.9: Lagrange's equations](#sec-1-8)
  - [Exercise 1.10: Higher-derivative Lagrangians](#sec-1-9)
  - [Exercise 1.11: Kepler's third law](#sec-1-10)
  - [Exercise 1.12: Lagrange's equations (code)](#sec-1-11)
  - [Exercise 1.13: Higher-derivative Lagrangians (code)](#sec-1-12)
  - [Exercise 1.14: Coordinate-independence of Lagrange equations](#sec-1-13)
  - [Exercise 1.15: Equivalence](#sec-1-14)
  - [Exercise 1.16: Central force motion](#sec-1-15)
  - [Exercise 1.17: Bead on a helical wire](#sec-1-16)
  - [Exercise 1.18: Bead on a triaxial surface](#sec-1-17)
  - [Exercise 1.19: Two-bar linkage](#sec-1-18)
  - [Exercise 1.20: Sliding pendulum](#sec-1-19)
  - [Exercise 1.21: A dumbbell](#sec-1-20)
  - [Exercise 1.22: Driven pendulum](#sec-1-21)
  - [Exercise 1.23: Fill in the details](#sec-1-22)
  - [Exercise 1.24: Constraint forces](#sec-1-23)
  - [Exercise 1.25: Foucalt pendulum Lagrangian](#sec-1-24)
  - [Exercise 1.26: Properties of \\(D\_t\\)](#sec-1-25)
  - [Exercise 1.27: Lagrange equations for total time derivatives](#sec-1-26)
  - [Exercise 1.28: Total Time Derivatives](#sec-1-27)
    - [part A](#sec-1-27-1)
    - [Part B](#sec-1-27-2)
    - [Part C](#sec-1-27-3)
    - [Part D](#sec-1-27-4)
    - [Part E](#sec-1-27-5)
    - [Part F](#sec-1-27-6)
  - [Exercise 1.29: Galilean Invariance](#sec-1-28)
  - [Exercise 1.30: Orbits in a central potential](#sec-1-29)
  - [Exercise 1.31: Foucault pendulum evolution](#sec-1-30)
  - [Exercise 1.32: Time-dependent constraints](#sec-1-31)
  - [Exercise 1.33: Falling off a log](#sec-1-32)
  - [Exercise 1.34: Driven spherical pendulum](#sec-1-33)
  - [Exercise 1.35: Restricted equations of motion](#sec-1-34)
  - [Exercise 1.36: Noether integral](#sec-1-35)
  - [Exercise 1.37: Velocity transformation](#sec-1-36)
  - [Exercise 1.38: Properties of \\(E\\)](#sec-1-37)
  - [Exercise 1.39: Combining Lagrangians](#sec-1-38)
  - [Exercise 1.40: Bead on a triaxial surface](#sec-1-39)
  - [Exercise 1.41: Motion of a tiny golf ball](#sec-1-40)
  - [Exercise 1.42: Augmented Lagrangian](#sec-1-41)
  - [Exercise 1.43: A numerical investigation](#sec-1-42)
  - [Exercise 1.44: Double pendulum behavior](#sec-1-43)
- [Rigid Bodies](#sec-2)
...
## Exercise 1.4: Lagrangian actions<a id="sec-1-3"></a>

## Exercise 1.5: Solution process<a id="sec-1-4"></a>

## Exercise 1.6: Minimizing action<a id="sec-1-5"></a>
...
## Exercise 1.7: Properties of \\(\delta\\)<a id="sec-1-6"></a>

## Exercise 1.8: Implementation of \\(\delta\\)<a id="sec-1-7"></a>
...
## Exercise 1.9: Lagrange's equations<a id="sec-1-8"></a>

## Exercise 1.10: Higher-derivative Lagrangians<a id="sec-1-9"></a>

## Exercise 1.11: Kepler's third law<a id="sec-1-10"></a>

## Exercise 1.12: Lagrange's equations (code)<a id="sec-1-11"></a>

## Exercise 1.13: Higher-derivative Lagrangians (code)<a id="sec-1-12"></a>

## Exercise 1.14: Coordinate-independence of Lagrange equations<a id="sec-1-13"></a>

## Exercise 1.15: Equivalence<a id="sec-1-14"></a>
...
## Exercise 1.16: Central force motion<a id="sec-1-15"></a>
...
## Exercise 1.17: Bead on a helical wire<a id="sec-1-16"></a>

## Exercise 1.18: Bead on a triaxial surface<a id="sec-1-17"></a>

## Exercise 1.19: Two-bar linkage<a id="sec-1-18"></a>

## Exercise 1.20: Sliding pendulum<a id="sec-1-19"></a>

## Exercise 1.21: A dumbbell<a id="sec-1-20"></a>
...
## Exercise 1.22: Driven pendulum<a id="sec-1-21"></a>

## Exercise 1.23: Fill in the details<a id="sec-1-22"></a>

## Exercise 1.24: Constraint forces<a id="sec-1-23"></a>

## Exercise 1.25: Foucalt pendulum Lagrangian<a id="sec-1-24"></a>

## Exercise 1.26: Properties of \\(D\_t\\)<a id="sec-1-25"></a>

## Exercise 1.27: Lagrange equations for total time derivatives<a id="sec-1-26"></a>

## Exercise 1.28: Total Time Derivatives<a id="sec-1-27"></a>

```scheme
(load "ch1/utils.scm")
```

### part A<a id="sec-1-27-1"></a>
...
## Exercise 1.29: Galilean Invariance<a id="sec-1-28"></a>
...
## Exercise 1.30: Orbits in a central potential<a id="sec-1-29"></a>

## Exercise 1.31: Foucault pendulum evolution<a id="sec-1-30"></a>

## Exercise 1.32: Time-dependent constraints<a id="sec-1-31"></a>

## Exercise 1.33: Falling off a log<a id="sec-1-32"></a>

## Exercise 1.34: Driven spherical pendulum<a id="sec-1-33"></a>

## Exercise 1.35: Restricted equations of motion<a id="sec-1-34"></a>

## Exercise 1.36: Noether integral<a id="sec-1-35"></a>

## Exercise 1.37: Velocity transformation<a id="sec-1-36"></a>

## Exercise 1.38: Properties of \\(E\\)<a id="sec-1-37"></a>

## Exercise 1.39: Combining Lagrangians<a id="sec-1-38"></a>

## Exercise 1.40: Bead on a triaxial surface<a id="sec-1-39"></a>

## Exercise 1.41: Motion of a tiny golf ball<a id="sec-1-40"></a>

## Exercise 1.42: Augmented Lagrangian<a id="sec-1-41"></a>

## Exercise 1.43: A numerical investigation<a id="sec-1-42"></a>

## Exercise 1.44: Double pendulum behavior<a id="sec-1-43"></a>
