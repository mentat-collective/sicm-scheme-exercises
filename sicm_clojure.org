...
#+RESULTS:
| #'ch1.ex1-17/turns->x-theta |
| #'ch1.ex1-17/x-theta->rect  |
| #'ch1.ex1-17/turns->rect*   |
...
#+RESULTS[d80c62cca2ab8d7539d44d2f9d8eec3a2b753ae7]:
:results:
\begin{equation}
\begin{pmatrix}\displaystyle{0} \cr \cr \displaystyle{0} \cr \cr \displaystyle{0}\end{pmatrix}
\end{equation}
...
#+RESULTS[6b86a52ae07d6c47901b0c000b33b045bfd8c437]:
:results:
\begin{equation}
...
#+RESULTS[352aa53da0936b44bcb5d807075be020c3741e81]:
:results:
\begin{equation}
...
#+RESULTS[fcd78ebc3bbb3ac9713437c365f52ef1d1318e68]:
:results:
\begin{equation}
...
#+RESULTS[b269741f5838a9198c2eb167c0b1df70c4046a37]:
:results:
\begin{equation}
...
#+RESULTS[7e314cc3b3cb84abd7876d1fe94a09e71d080c76]:
:results:
\begin{equation}
...
#+RESULTS[8111d855bca7c3ac2cb695bd8f2a5d56bf96c50a]:
:results:
\begin{equation}
\begin{bmatrix}\displaystyle{g\,l_1\,m_1\,\sin\left(\theta\left(t\right)\right) + 2\,{l_1}^{2}\,m_1\,{D}^{2}\theta\left(t\right) + 2\,l_1\,m_1\,\sin\left(\theta\left(t\right)\right)\,{D}^{2}y_2\left(t\right) + 2\,l_1\,m_1\,\cos\left(\theta\left(t\right)\right)\,{D}^{2}x_2\left(t\right)} \cr \cr \displaystyle{g\,l_2\,m_3\,\sin\left(\phi\left(t\right)\right) + 2\,{l_2}^{2}\,m_3\,{D}^{2}\phi\left(t\right) + 2\,l_2\,m_3\,\cos\left(\phi\left(t\right)\right)\,{D}^{2}x_2\left(t\right) + 2\,l_2\,m_3\,\sin\left(\phi\left(t\right)\right)\,{D}^{2}y_2\left(t\right)} \cr \cr \displaystyle{-2\,l_1\,m_1\,\sin\left(\theta\left(t\right)\right)\,{\left(D\theta\left(t\right)\right)}^{2} -2\,l_2\,m_3\,{\left(D\phi\left(t\right)\right)}^{2}\,\sin\left(\phi\left(t\right)\right) + 2\,l_1\,m_1\,{D}^{2}\theta\left(t\right)\,\cos\left(\theta\left(t\right)\right) + 2\,l_2\,m_3\,{D}^{2}\phi\left(t\right)\,\cos\left(\phi\left(t\right)\right) + 2\,m_1\,{D}^{2}x_2\left(t\right) + 2\,m_2\,{D}^{2}x_2\left(t\right) + 2\,m_3\,{D}^{2}x_2\left(t\right)} \cr \cr \displaystyle{2\,l_1\,m_1\,{\left(D\theta\left(t\right)\right)}^{2}\,\cos\left(\theta\left(t\right)\right) + 2\,l_2\,m_3\,{\left(D\phi\left(t\right)\right)}^{2}\,\cos\left(\phi\left(t\right)\right) + 2\,l_1\,m_1\,\sin\left(\theta\left(t\right)\right)\,{D}^{2}\theta\left(t\right) + 2\,l_2\,m_3\,{D}^{2}\phi\left(t\right)\,\sin\left(\phi\left(t\right)\right) + g\,m_1 + g\,m_2 + g\,m_3 + 2\,m_1\,{D}^{2}y_2\left(t\right) + 2\,m_2\,{D}^{2}y_2\left(t\right) + 2\,m_3\,{D}^{2}y_2\left(t\right)}\end{bmatrix}
\end{equation}
:end:
...
#+RESULTS[47708c83042996fe022ee86787fc9dcb3ce03f71]:
:results:
\begin{equation}
\begin{pmatrix}\displaystyle{g\,\sin\left(\theta\left(t\right)\right) + 2\,l_1\,{D}^{2}\theta\left(t\right) + 2\,\sin\left(\theta\left(t\right)\right)\,{D}^{2}y_2\left(t\right) + 2\,\cos\left(\theta\left(t\right)\right)\,{D}^{2}x_2\left(t\right)} \cr \cr \displaystyle{g\,\sin\left(\phi\left(t\right)\right) + 2\,l_2\,{D}^{2}\phi\left(t\right) + 2\,\cos\left(\phi\left(t\right)\right)\,{D}^{2}x_2\left(t\right) + 2\,\sin\left(\phi\left(t\right)\right)\,{D}^{2}y_2\left(t\right)} \cr \cr \displaystyle{- l_1\,m_1\,\sin\left(\theta\left(t\right)\right)\,{\left(D\theta\left(t\right)\right)}^{2} - l_2\,m_3\,{\left(D\phi\left(t\right)\right)}^{2}\,\sin\left(\phi\left(t\right)\right) + l_1\,m_1\,{D}^{2}\theta\left(t\right)\,\cos\left(\theta\left(t\right)\right) + l_2\,m_3\,{D}^{2}\phi\left(t\right)\,\cos\left(\phi\left(t\right)\right) + m_1\,{D}^{2}x_2\left(t\right) + m_2\,{D}^{2}x_2\left(t\right) + m_3\,{D}^{2}x_2\left(t\right)} \cr \cr \displaystyle{2\,l_1\,m_1\,{\left(D\theta\left(t\right)\right)}^{2}\,\cos\left(\theta\left(t\right)\right) + 2\,l_2\,m_3\,{\left(D\phi\left(t\right)\right)}^{2}\,\cos\left(\phi\left(t\right)\right) + 2\,l_1\,m_1\,\sin\left(\theta\left(t\right)\right)\,{D}^{2}\theta\left(t\right) + 2\,l_2\,m_3\,{D}^{2}\phi\left(t\right)\,\sin\left(\phi\left(t\right)\right) + g\,m_1 + g\,m_2 + g\,m_3 + 2\,m_1\,{D}^{2}y_2\left(t\right) + 2\,m_2\,{D}^{2}y_2\left(t\right) + 2\,m_3\,{D}^{2}y_2\left(t\right)}\end{pmatrix}
\end{equation}
:end:
...
#+RESULTS[fc22b20384e52b4ad23139d2b1c43d2a54603e0b]:
:results:
\begin{equation}
...
#+RESULTS[c0c8e336bd998f7713af3c7bdedd859cbf0262f0]:
:results:
\begin{equation}
\begin{bmatrix}\displaystyle{-2\,l\,m_2\,\sin\left(\theta\left(t\right)\right)\,{\left(D\theta\left(t\right)\right)}^{2} + 2\,l\,m_2\,{D}^{2}\theta\left(t\right)\,\cos\left(\theta\left(t\right)\right) + 2\,m_1\,{D}^{2}x_1\left(t\right) + 2\,m_2\,{D}^{2}x_1\left(t\right)} \cr \cr \displaystyle{g\,l\,m_2\,\sin\left(\theta\left(t\right)\right) + 2\,{l}^{2}\,m_2\,{D}^{2}\theta\left(t\right) + 2\,l\,m_2\,\cos\left(\theta\left(t\right)\right)\,{D}^{2}x_1\left(t\right)}\end{bmatrix}
\end{equation}
:end:
...
#+RESULTS[2c1a674857979a2bacccb0bc8ff0e2de94f13774]:
:results:
\begin{equation}
\begin{pmatrix}\displaystyle{-2\,l\,m_2\,\sin\left(\theta\left(t\right)\right)\,{\left(D\theta\left(t\right)\right)}^{2} + 2\,l\,m_2\,{D}^{2}\theta\left(t\right)\,\cos\left(\theta\left(t\right)\right) + 2\,m_1\,{D}^{2}x_1\left(t\right) + 2\,m_2\,{D}^{2}x_1\left(t\right)} \cr \cr \displaystyle{g\,\sin\left(\theta\left(t\right)\right) + 2\,l\,{D}^{2}\theta\left(t\right) + 2\,\cos\left(\theta\left(t\right)\right)\,{D}^{2}x_1\left(t\right)}\end{pmatrix}
\end{equation}
:end:
...
#+RESULTS[d2368821bb607531a6f2c19404301d2f48270db5]:
:results:
\begin{equation}
...
#+RESULTS[d0d0bf751a301e9187d5f12783654c2a8d47bb5f]:
:results:
\begin{equation}
...
#+RESULTS[347455a1bf6c85254eb86c4139b220b16c1aba78]:
:results:
\begin{equation}
...
#+RESULTS[8b78e339b654aa73cfb638fdc47564b178adbd47]:
:results:
\begin{equation}
...
#+RESULTS[3d9819d33ed9d856299f5d9565cb90bf0aaa263f]:
:results:
\begin{equation}
\begin{bmatrix}\displaystyle{m_0\,{D}^{2}x_{cm}\left(t\right) + m_1\,{D}^{2}x_{cm}\left(t\right)} \cr \cr \displaystyle{m_0\,{D}^{2}y_{cm}\left(t\right) + m_1\,{D}^{2}y_{cm}\left(t\right)} \cr \cr \displaystyle{\frac{2\,m_0\,m_1\,D\theta\left(t\right)\,c\left(t\right)\,Dc\left(t\right) + m_0\,m_1\,{D}^{2}\theta\left(t\right)\,{\left(c\left(t\right)\right)}^{2}}{m_0 + m_1}} \cr \cr \displaystyle{\frac{- l\,m_0\,m_1\,{\left(D\theta\left(t\right)\right)}^{2}\,c\left(t\right) + l\,m_0\,m_1\,{D}^{2}c\left(t\right) + m_0\,F\left(t\right)\,c\left(t\right) + m_1\,F\left(t\right)\,c\left(t\right)}{l\,m_0 + l\,m_1}} \cr \cr \displaystyle{\frac{- {l}^{2} + {\left(c\left(t\right)\right)}^{2}}{2\,l}}\end{bmatrix}
\end{equation}
:end:
...
#+RESULTS[1d72de7d5c5f3f3c79cf20a41e64e48aa44e9dec]:
:results:
\begin{equation}
...
#+RESULTS[302f96b7def456d623132eb3eff0160eeec5782e]:
:results:
\begin{equation}
0
\end{equation}
...
#+RESULTS[56daae7aa9a507dbf47cb5c1718ab63fe0b0bf47]:
:results:
\begin{equation}
...
#+RESULTS[d6d85683a3f6ea985c97b9668fc1e7ab706a91f8]:
:results:
\begin{equation}
\begin{bmatrix}\displaystyle{\frac{l\,m\,{D}^{2}x\left(t\right) + x\left(t\right)\,F\left(t\right)}{l}} \cr \cr \displaystyle{\frac{g\,l\,m + l\,m\,{D}^{2}y\left(t\right) + y\left(t\right)\,F\left(t\right) - F\left(t\right)\,y_s\left(t\right)}{l}} \cr \cr \displaystyle{\frac{- {l}^{2} + {\left(x\left(t\right)\right)}^{2} + {\left(y\left(t\right)\right)}^{2} -2\,y\left(t\right)\,y_s\left(t\right) + {\left(y_s\left(t\right)\right)}^{2}}{2\,l}}\end{bmatrix}
\end{equation}
:end:
...
#+RESULTS[8b5ed990be36d75f0e25a36aa7cb75b4da19e03a]:
:results:
\begin{equation}
0
\end{equation}
...
#+RESULTS[309d62d5c69997b9e151991d8f68e04511e6ad29]:
:results:
\begin{equation}
\frac{1}{2}\,{l}^{2}\,m\,{\left(D\theta\left(t\right)\right)}^{2} + l\,m\,\sin\left(\theta\left(t\right)\right)\,D\theta\left(t\right)\,Dy_s\left(t\right) + g\,l\,m\,\cos\left(\theta\left(t\right)\right) - g\,m\,y_s\left(t\right) + \frac{1}{2}\,m\,{\left(Dy_s\left(t\right)\right)}^{2}
\end{equation}
:end:
...
#+RESULTS[2f4e5344fe096110b5375d768b5ec95981ce34ac]:
:results:
\begin{equation}
...
#+RESULTS[cb25190a3517f2c5140e4f3c5f7feaf98caaeadf]:
:results:
\begin{equation}
...
#+RESULTS[92401efb05c9e5c5f907eaeacdfd349a99c25533]:
:results:
\begin{equation}
...
#+RESULTS[dbd808acbafa7aeae5940f2fa7adddf4081f74c5]:
:results:
\begin{equation}
...
#+RESULTS[3aa25b5514b22239dfb4232a0abd79833eff29ab]:
:results:
\begin{equation}
...
#+RESULTS[c69796e7a6c18d350def3f016364a0f66bc44275]:
:results:
\begin{equation}
...
#+RESULTS[c3bf3ad567f028b1677f9cc8d62f1a6f97ee8abe]:
:results:
\begin{equation}
...
#+RESULTS[8d696e3f24120cfbd568683f92ebdd7032efcb5d]:
:results:
\begin{equation}
\begin{bmatrix}\displaystyle{2\,x\,{y}^{3}} \cr \cr \displaystyle{3\,{x}^{2}\,{y}^{2}}\end{bmatrix}
\end{equation}
...
#+RESULTS[6d4c38fd412bd39afe95140f0884842dd2b09142]:
:results:
\begin{equation}
...
#+RESULTS[a05f78c71d33d44a8a212479682bdd829a067b8f]:
:results:
\begin{equation}
...
#+RESULTS[459066205bb9b26a3738baaa5eb88506ee123770]:
:results:
\begin{equation}
...
#+RESULTS[61a932b835a8c894cd73f0755d78807f618cae2b]:
:results:
\begin{equation}
...
#+RESULTS[773a57c47d9567bae4db718e63c27c47ff94b5fa]:
:results:
\begin{equation}
\begin{pmatrix}\displaystyle{\begin{bmatrix}\displaystyle{2\,a\,{b}^{3}} \cr \cr \displaystyle{3\,{a}^{2}\,{b}^{2}}\end{bmatrix}} \cr \cr \displaystyle{\begin{bmatrix}\displaystyle{\begin{pmatrix}\displaystyle{750} \cr \cr \displaystyle{0}\end{pmatrix}} \cr \cr \displaystyle{\begin{pmatrix}\displaystyle{675} \cr \cr \displaystyle{1}\end{pmatrix}}\end{bmatrix}} \cr \cr \displaystyle{\begin{bmatrix}\displaystyle{210937500\,{a}^{6}\,{b}^{27}} \cr \cr \displaystyle{284765625\,{a}^{8}\,{b}^{24}}\end{bmatrix}}\end{pmatrix}
\end{equation}
...
#+RESULTS[61f1eb11a14638204fb44bfc8e6b572ea379df1f]:
:results:
...
#+RESULTS[d71d450663a7baa1a74c0b54d9635bfc15f40e25]:
| up | 1 | 2 | t |
