...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_3.cljc :comments org
:END:
...
#+begin_src clojure :results output raw :exports both :cache yes
(->tex-equation
 ((total-distance 'x_1 'y_1 'x_2 'y_2) 'x_p))
#+end_src

#+RESULTS[04e61317301798230c621991e29e6d11cf4fa53d]:
\begin{equation}
...
#+RESULTS[f109347c1aeeca0d9930708f25b97ada609deca0]:
\begin{equation}
...
#+RESULTS[2da7be317e00ff5395dfef92ec529d68240add5b]:
\begin{equation}
...
#+RESULTS[c971a3fbe7f21ac2fadbda521eaa0981bd365f64]:
\begin{equation}
\begin{pmatrix}\displaystyle{\frac{x_2\,y_1}{y_1\,\sqrt {\frac{{x_2}^{2}\,{y_1}^{2} + {y_1}^{4} + 2\,{y_1}^{3}\,y_2 + {y_1}^{2}\,{y_2}^{2}}{{y_1}^{2} + 2\,y_1\,y_2 + {y_2}^{2}}} + y_2\,\sqrt {\frac{{x_2}^{2}\,{y_1}^{2} + {y_1}^{4} + 2\,{y_1}^{3}\,y_2 + {y_1}^{2}\,{y_2}^{2}}{{y_1}^{2} + 2\,y_1\,y_2 + {y_2}^{2}}}}} \cr \cr \displaystyle{\frac{- x_2\,y_2}{y_1\,\sqrt {\frac{{x_2}^{2}\,{y_2}^{2} + {y_1}^{2}\,{y_2}^{2} + 2\,y_1\,{y_2}^{3} + {y_2}^{4}}{{y_1}^{2} + 2\,y_1\,y_2 + {y_2}^{2}}} + y_2\,\sqrt {\frac{{x_2}^{2}\,{y_2}^{2} + {y_1}^{2}\,{y_2}^{2} + 2\,y_1\,{y_2}^{3} + {y_2}^{4}}{{y_1}^{2} + 2\,y_1\,y_2 + {y_2}^{2}}}}}\end{pmatrix}
\end{equation}
...
(let [y_1 5
      x_2 6
      y_2 7
      distance-fn (total-distance 0 y_1 x_2 y_2)
      derivative  (D distance-fn)]
  (->tex-equation
   (derivative (/ (* y_1 x_2) (+ y_1 y_2)))))
#+end_src

#+RESULTS[db44f64f9df325c806076b76f0de3a3eeeedfe8b]:
\begin{equation}
0
\end{equation}
...
#+begin_src clojure
(defn cake [x] (/ x (sqrt (+ (square 'y_1) (square x)))))
#+end_src
...
#+begin_src clojure :results output raw :exports both :cache yes
(->tex-equation
 (cake (/ (* 'y_1 'x_2) (+ 'y_1 'y_2))))
#+end_src

#+RESULTS[7f70f8c3c44cc5c5c83142386501d73023cd7ba6]:
\begin{equation}
\frac{x_2\,y_1}{y_1\,\sqrt {\frac{{x_2}^{2}\,{y_1}^{2} + {y_1}^{4} + 2\,{y_1}^{3}\,y_2 + {y_1}^{2}\,{y_2}^{2}}{{y_1}^{2} + 2\,y_1\,y_2 + {y_2}^{2}}} + y_2\,\sqrt {\frac{{x_2}^{2}\,{y_1}^{2} + {y_1}^{4} + 2\,{y_1}^{3}\,y_2 + {y_1}^{2}\,{y_2}^{2}}{{y_1}^{2} + 2\,y_1\,y_2 + {y_2}^{2}}}}
\end{equation}

#+begin_src clojure :results output raw :exports both :cache yes
(->tex-equation
 (+ (* (square 'y_1) (sqrt (/ (+ (* (expt 'x_2 2) (expt 'y_1 2)) (expt 'y_1 4) (* 2 (expt 'y_1 3) 'y_2) (* (expt 'y_1 2) (expt 'y_2 2))) (+ (expt 'y_1 2) (* 2 'y_1 'y_2) (expt 'y_2 2)))))
    (* (square 'y_2) (sqrt (/ (+ (* (expt 'x_2 2) (expt 'y_1 2)) (expt 'y_1 4) (* 2 (expt 'y_1 3) 'y_2) (* (expt 'y_1 2) (expt 'y_2 2))) (+ (expt 'y_1 2) (* 2 'y_1 'y_2) (expt 'y_2 2)))))))
#+end_src

#+RESULTS[64daa90af1f97b2f5eb9c32dc9678dc4e8115447]:
\begin{equation}
{y_1}^{2}\,\sqrt {\frac{{x_2}^{2}\,{y_1}^{2} + {y_1}^{4} + 2\,{y_1}^{3}\,y_2 + {y_1}^{2}\,{y_2}^{2}}{{y_1}^{2} + 2\,y_1\,y_2 + {y_2}^{2}}} + {y_2}^{2}\,\sqrt {\frac{{x_2}^{2}\,{y_1}^{2} + {y_1}^{4} + 2\,{y_1}^{3}\,y_2 + {y_1}^{2}\,{y_2}^{2}}{{y_1}^{2} + 2\,y_1\,y_2 + {y_2}^{2}}}
\end{equation}
...
:PROPERTIES:
:header-args+: :tangle ch1/sec1-4.cljc :comments org
:END:
...
#+RESULTS:
: ;Loading "ch1/utils.cljc"...
: ;  Loading "ch1/exdisplay.cljc"... done
: ;... done
: #| check-f |#
...
:PROPERTIES:
:header-args+: :tangle ch1/min-action-paths.cljc :comments org
:END:
...
#+begin_src clojure :results output raw :exports both :cache yes :noweb yes
<<test-path>>
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_5.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_6.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_8.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_10.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_11.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_12.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_13.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_14.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_15.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_16.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_21.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_22.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_23.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_24.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_25.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_26.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_27.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_28.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_29.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_30.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_31.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_32.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_33.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_34.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_35.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_36.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_37.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_38.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_39.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_40.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_41.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_42.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_43.cljc :comments org
:END:
...
:PROPERTIES:
:header-args+: :tangle ch1/ex1_44.cljc :comments org
:END:
...
** Exercise 9.1 Chain Rule
     :PROPERTIES:
     :header-args+: :tangle ch9/ex9-1.cljc :comments org
     :END:
...
** Exercise 9.2: Computing Derivatives
     :PROPERTIES:
     :header-args+: :tangle ch9/ex9-2.cljc :comments org
     :END:
